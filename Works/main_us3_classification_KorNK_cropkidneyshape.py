...
parser.add_argument('--data', default='~/data/KorNK/1200/CropKidneyShape', help='path to dataset')
...
parser.add_argument('--resume', default='/media/bong07/895GB/data/yonsei/model/M2_classification_kidney/result_CropKidneyShape/checkpoint_78.pth', type=str, help='path to latest checkpoint')
parser.add_argument('--evaluate', default=True, action='store_true', help='evaluate model on validation set')
parser.add_argument('--seed', default=None, type=int, help='seed for initializing training')
parser.add_argument('--result', default='../result_KorNK_1200/result_CropKidneyShape', help='path to result')
