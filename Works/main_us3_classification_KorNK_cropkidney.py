...
parser.add_argument('--data', default='~/data/KorNK/1200/CropKidney', help='path to dataset')
...
parser.add_argument('--resume', default='/media/bong07/895GB/data/yonsei/model/M2_classification_kidney/result_CropKidney/checkpoint_72.pth', type=str, help='path to latest checkpoint')
parser.add_argument('--evaluate', default=True, action='store_true', help='evaluate model on validation set')
parser.add_argument('--seed', default=None, type=int, help='seed for initializing training')
parser.add_argument('--result', default='../result_KorNK_1200/result_CropKidney', help='path to result')
